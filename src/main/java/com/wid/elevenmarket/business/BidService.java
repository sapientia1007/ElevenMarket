...
public class BidService {
    ...
    @Transactional
    public BidResponseDto processBid(BidProcessRequestDto bidProcessRequestDto) {
        Long userId = bidProcessRequestDto.getUserId();
        Long auctionId = bidProcessRequestDto.getAuctionId();
        BigDecimal bidPrice = bidProcessRequestDto.getBidPrice();
